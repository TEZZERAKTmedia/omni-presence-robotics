...
def control_cat_toy(direction, str):
    ...
    if direction == 'left':
        ...
        servo_controller.pmw_servo.set_servo_pulse(servo_controller.pmw_channel_map[channel], 1300)
    elif direction == 'right':
        print("[CAT TOY] Spinning right")
        servo_controller.pmw_servo.set_servo_pulse(servo_controller.pmw_schannel_map[channel], 1700)
    else:
